...
function renderLeaderboard(viewModel) {
  if (
    ...
    !elements.leaderboardMatchesCount ||
    !elements.leaderboardTrackedBots ||
    !elements.leaderboardPromotedCount ||
    !elements.leaderboardCurrentLeader ||
    !elements.leaderboardSnapshot
  ) {
    return;
  }
